...
function roots_scripts() {
  ...
  wp_register_script('modernizr', get_template_directory_uri() . '/assets/js/vendor/modernizr-2.6.2.min.js', false, null, false);
	wp_register_script('waypoints', get_template_directory_uri() . '/assets/js/vendor/waypoints.min.js', false, null, false);
	wp_register_script('waypoints_sticky', get_template_directory_uri() . '/assets/js/vendor/waypoints-sticky.min.js', false, null, false);
